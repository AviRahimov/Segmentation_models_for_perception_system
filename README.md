...
|                            v                                              |
|                     +--------------+                                      |
|                     |  PyQt5 UI    |  play / pause / seek / fullscreen    |
|                     +--------------+                                      |
+--------------------------------------------------------------------------+
```
...
| `temporal.semantic_skip_frames`                  | `1`                                         | Run SegFormer every N frames; reuse last EMA-smoothed result on skipped frames. `1` = every frame. `2` = half SegFormer cost (~28ms avg/frame); safe for stable terrain. Scene cuts and seeks always force immediate inference.                                                                                                                                                                                                                    |
...
| `player.draw_road_ground_semantic_last`          | `true`                                      | Render `road_ground` semantic mask on top of other semantic classes (z-order). Prevents it from being covered by `non_traversable`.                                                                                                                                                                                                                                                                                                               |
...
src/perception/
  ...
  ui/          PyQt5 widgets + decode/inference QThread workers
