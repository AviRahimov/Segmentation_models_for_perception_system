...
-----
    ...
    PYTHONPATH=src python scripts/segmentation/evaluation/eval_segformer_on_datasets.py --samples 24
"""
...
def _write_index(
    ...
    lines.append("")
    lines.append(
        "Generated by `scripts/segmentation/evaluation/eval_segformer_on_datasets.py`. Each row "
